import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, getCurrentScope, onScopeDispose, shallowRef, isReadonly, toRefs, markRaw, isShallow } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./fre/index-piu9qQ9m.mjs').then((m) => m.default || m)
  }
];
...
const mid_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
});
...
const namedMiddleware = {
  amid: () => import('./fre/amid-aQzIuX-6.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./fre/Icon-W9IktuBI.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./fre/IconCSS-w2KsyOTK.mjs').then((r) => r.default));
...
const error_ldt3PQauZ0 = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
});
const vueApp_V6QTXIV3S8 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./fre/default-KWYPoSjr.mjs').then((m) => m.default || m)
};
...
const base = {
  app_name: "聪明钱一站式导航平台",
  web_host: "https://www.smartwallex.com",
  logo: "/smartwallex2.jpg"
};
const seo = {
  title: "smartwallex:聪明钱一站式导航平台",
  description: "币圈导航| 区块链导航| WEB3导航|聪明钱导航  聪明钱包导航平台 专注于为您提供各种聪明钱包信息，包括交易所资源、链上数据、一级工具等。无论您在寻找哪种资源，我们都将尽力为您提供，为您的学习或工作助力",
  keywords: "Web3,最全导航,币圈导航,比特币,狗狗币,以太坊,MEME,瑞波币, 免费加密货币,Pnut,Doge,金狗,土狗,投研,PNut,BTC,ETH,BITCOIN, 优质币圈资源, 资源聚合, 在线资源, 链上数据, 币种信息, 币种行情, 币种分析, 币种交易, 币种钱包, 币种工具, 钱包平台",
  icon: "/smartwallex2.jpg"
};
const header = {
  search: {
    is_show: true,
  ...
  list: [
    {
      ...
      icon_size: 20,
      icon_color: "#00b140",
      icon_hover_color: "#008733",
      text: "有兴趣加我微信：btcgo6868",
      img: "/btcgo6868_wx.jpg",
      url: ""
    },
    {
...
const CONFIG_KEY_BASE = "base";
const CONFIG_KEY_SEO = "seo";
const CONFIG_KEY_HERDER = "header";
const CONFIG_KEY_PENDANT = "pendant";
const CONFIG_KEY_FOOTER = "footer";
const KeyMap = {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./fre/error-404-WNit2ZAu.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./fre/error-500-W0nDWG55.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./fre/island-renderer-Y7-fQ05V.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { CONFIG_KEY_SEO as C, useRuntimeConfig as a, navigateTo as b, createError as c, useHead as d, entry$1 as default, defineNuxtRouteMiddleware as e, defineStore as f, getConfigItem as g, useRoute as h, CONFIG_KEY_BASE as i, CONFIG_KEY_HERDER as j, CONFIG_KEY_PENDANT as k, CONFIG_KEY_FOOTER as l, useNuxtApp as m, nuxtLinkDefaults as n, useRouter as u };
