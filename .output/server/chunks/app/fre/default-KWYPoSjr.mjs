...
import { useSSRContext, defineComponent, computed, watch, h, ref, onUnmounted, withAsyncContext, mergeProps, unref, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, toDisplayString, createCommentVNode } from 'vue';
import { f as defineStore, h as useRoute, g as getConfigItem, i as CONFIG_KEY_BASE, j as CONFIG_KEY_HERDER, k as CONFIG_KEY_PENDANT, l as CONFIG_KEY_FOOTER, b as navigateTo } from '../server.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderVNode } from 'vue/server-renderer';
...
const useResourceStore = defineStore(
  ...
  () => {
    ...
    const setSearchOrder = (resourceType, resourceList) => {
      searchOrder.value[resourceType] = resourceList;
    };
    const setSelectedResourceType = (resourceType) => {
      selectedResourceType.value = resourceType;
    };
    const setSelectedResource = (resource) => {
      selectedResource.value = resource;
    };
    const getResourceList = (resourceType, withOptions = false, isOriginal = false) => {
      var _a;
      let resourceList = (_a = resourceConfig[resourceType].list) != null ? _a : [];
      if (!resourceList) {
        navigateTo("/404");
      }
    ...
    const formatResourceList = (resourceType, resourceList) => {
      var _a;
      if (!resourceList || resourceList.length == 0) {
        return;
      }
      const resourceConfig2 = (_a = searchOrder.value[resourceType]) != null ? _a : [];
      if (!resourceConfig2) {
        return resourceList;
      }
      let resultList = [];
      resourceConfig2.forEach((name) => {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const selectedResource = ref();
    const currResourceType = ref();
    const getResourceType = async (type) => {
      var _a;
      ...
      if (!currResourceType.value) {
        ...
        selectedResourceType.value = (_a = currResourceType.value) == null ? void 0 : _a.key;
        searchStore.setSelectedResource(selectedResourceType.value);
      }
    };
    [__temp, __restore] = withAsyncContext(() => getResourceType(selectedResourceType.value)), await __temp, __restore();
    const currTab = ref(0);
    ...
    const handleSearch = () => {
      var _a;
      const url = `${(_a = selectedResource.value) == null ? void 0 : _a.url}`.replaceAll("{keyword}", keyword.value);
      navigateTo(url, {
        open: {
          target: "_blank"
        }
    ...
    const generatePlaceholder = () => {
      var _a, _b;
      return ((_a = selectedResource.value) == null ? void 0 : _a.name) == "\u5168\u90E8" ? "\u8BF7\u8F93\u5165\u60A8\u8981\u641C\u7D22\u7684\u5185\u5BB9..." : `\u5728 ${(_b = selectedResource.value) == null ? void 0 : _b.name} \u4E2D\u641C\u7D22`;
    };
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_Icon = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex items-center justify-center flex-col" }, _attrs))} data-v-7b618a1f><ul class="flex py-2 pl-[4rem] w-full text-sm relative" id="resource-menu" data-v-7b618a1f><li id="search_tab_anchor" class="anchor text-[14px] h-full" data-v-7b618a1f></li><!--[-->`);
      ssrRenderList(unref(resourceList), (item, i) => {
        _push(`<li${ssrRenderAttr("id", `search_tab_${i}`)} class="${ssrRenderClass([`${unref(currTab) == i ? "text-[#007bff]" : ""}`, "flex px-2 div-center hover:text-[#007bff] truncate"])}" data-v-7b618a1f>`);
        if (item.icon) {
          _push(`<img${ssrRenderAttr("src", item.icon)} alt="" class="w-[12px] h-[12px]" data-v-7b618a1f>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="ml-1 hidden lg:block" data-v-7b618a1f>${ssrInterpolate(item.name)}</div></li>`);
      });
      _push(`<!--]--></ul><div class="w-full flex mt-1 rounded-md pr-2 bg-slate-100 items-center cursor-pointer" data-v-7b618a1f><div class="flex items-center min-w-[4rem] cursor-pointer relative hover:bg-[rgba(226,232,240,0.3)] rounded-t-md" data-v-7b618a1f><span class="text-center py-2 w-full" data-v-7b618a1f>${ssrInterpolate((_a = unref(currResourceType)) == null ? void 0 : _a.name)}</span><ul class="${ssrRenderClass([`${unref(showResourceList) ? "opacity-100 h-auto  rounded-b-none" : "opacity-0 h-0"}`, "absolute top-[40px] left-0 min-w-[4rem] truncate transition-all duration-500 flex-col shadow-lg rounded-b-md z-[1000] bg-gray-50"])}" data-v-7b618a1f><!--[-->`);
      ssrRenderList(unref(resourceTypeList), (resourceType, i) => {
        _push(`<li class="py-2 w-full text-center cursor-pointer transition-all duration-300 hover:bg-[rgba(226,232,240)]" data-v-7b618a1f>${ssrInterpolate(resourceType.name)}</li>`);
      });
      _push(`<!--]--></ul></div><div class="h-full relative flex-grow" data-v-7b618a1f><input class="w-full lg:min-w-[600px] bg-slate-100 h-6 px-2 py-1 border-l-[2px] border-l-slate-200 focus:outline-none" type="text"${ssrRenderAttr("value", unref(keyword))}${ssrRenderAttr("placeholder", generatePlaceholder())} data-v-7b618a1f></div><div class="justify-end" data-v-7b618a1f>`);
...
_sfc_main$5.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Index/IndexSearch.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-7b618a1f"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const headerAnimation = (action) => {
      const headerDom = (void 0).getElementById("fre123-header");
      const searchDom = (void 0).getElementById("resource-menu");
      if (headerDom) {
        if (action == "smaller") {
          headerDom.classList.add("custom-size");
          searchDom == null ? void 0 : searchDom.classList.add("hidden");
        } else {
          headerDom.classList.remove("custom-size");
          searchDom == null ? void 0 : searchDom.classList.remove("hidden");
        }
      }
    };
    const isShow = ref(false);
    __expose({ headerAnimation });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
      const _component_IndexSearch = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full bg-white sticky top-0 z-[110]" }, _attrs))} data-v-80668798><div id="fre123-header" class="header-transition m-auto flex border-b-2 border-b-gray-50 md:px-[20px] py-[10px]" data-v-80668798><div class="flex md:basis-1/3 relative" data-v-80668798><a${ssrRenderAttr("href", unref(baseInfo)["web_host"])} target="_blank" data-v-80668798><img class="header-logo header-transition ml-[20px]"${ssrRenderAttr("src", unref(baseInfo)["logo"])} alt="" data-v-80668798></a><a${ssrRenderAttr("href", unref(baseInfo)["web_host"])} target="_blank" class="header-text header-transition ml-[10px] leading-[80px] md:text-[22px] text-[#333]" data-v-80668798>${ssrInterpolate(unref(baseInfo)["app_name"])}</a></div><div style="${ssrRenderStyle(_ctx.showSearch ? null : { display: "none" })}" class="flex-grow hidden md:flex items-center justify-center cursor-pointer" data-v-80668798>`);
      _push(ssrRenderComponent(_component_IndexSearch, null, null, _parent));
      _push(`</div><div class="cursor-pointer hidden md:flex basis-1/3 items-center justify-end" data-v-80668798>`);
      if (unref(headerConfig).right.is_show) {
        _push(`<div class="flex justify-end flex-grow relative" data-v-80668798><div class="px-3 flex items-center justify-end header-transition md:text-[16px] text-[#333333] p-2" data-v-80668798>`);
        if ((_b = (_a = unref(headerConfig).right) == null ? void 0 : _a.group) == null ? void 0 : _b.name) {
          _push(`<a${ssrRenderAttr("href", (_d = (_c = unref(headerConfig).right) == null ? void 0 : _c.group) == null ? void 0 : _d.url)} target="_blank" class="px-3 bg-opacity-50 transition-bg-hover-200 cursor-pointer" data-v-80668798>${ssrInterpolate((_f = (_e = unref(headerConfig).right) == null ? void 0 : _e.group) == null ? void 0 : _f.name)}</a>`);
        } else {
          _push(`<!---->`);
        }
        if (((_h = (_g = unref(headerConfig).right) == null ? void 0 : _g.group) == null ? void 0 : _h.children) && ((_j = (_i = unref(headerConfig).right) == null ? void 0 : _i.group) == null ? void 0 : _j.children.length) > 0) {
          _push(`<div class="${ssrRenderClass([`${unref(isShow) ? " opacity-100" : "opacity-0"}`, "absolute transition-all text-[16px] bottom-[-120px] bg-white rounded-md shadow-lg"])}" data-v-80668798><ul class="" data-v-80668798><!--[-->`);
          ssrRenderList((_l = (_k = unref(headerConfig).right) == null ? void 0 : _k.group) == null ? void 0 : _l.children, (item) => {
            _push(`<li class="px-3 transition-bg-hover-200 cursor-pointer" data-v-80668798><a${ssrRenderAttr("href", item.url)} target="_blank" data-v-80668798>${ssrInterpolate(item.name)}</a></li>`);
          });
          _push(`<!--]--></ul></div>`);
        } else {
          _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-80668798"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(FontAwesomeIcon), {
        icon: __props.icon,
        style: { "font-size": `${__props.size}px` }
      }, null, _parent));
      _push(`</div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Icons/FontAwesome.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const switchHoverIdx = (val) => {
      hoverIdx.value = val;
    };
    const handleScroll = () => {
      const dom2 = (void 0).getElementById("wrap");
      if (dom2) {
        const t = dom2 == null ? void 0 : dom2.getBoundingClientRect().top;
        if (t < 75) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconsFontAwesome = _sfc_main$3;
      if (unref(pendantConfig).is_show) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          id: "navbar-pendant",
          class: "z-50 fixed right-[10px] opacity-90 top-[60%]"
        }, _attrs))} data-v-3da2c1bf><ul data-v-3da2c1bf><!--[-->`);
        ssrRenderList(unref(pendantConfig).list, (item, i) => {
          _push(`<li style="${ssrRenderStyle({
            color: `${item.icon_color}`
          })}" class="${ssrRenderClass([`hover:text-${item.icon_hover_class}`, "navbar-icon-style"])}" data-v-3da2c1bf>`);
          ssrRenderVNode(_push, createVNode(resolveDynamicComponent((item == null ? void 0 : item.url) ? "a" : "div"), {
            href: item == null ? void 0 : item.url,
            target: "_blank"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_IconsFontAwesome, {
                  icon: item == null ? void 0 : item.icon_class,
                  size: item.icon_size,
                  onMouseenter: ($event) => switchHoverIdx(i),
                  onMouseleave: ($event) => switchHoverIdx(-1)
                }, null, _parent2, _scopeId));
                if (item == null ? void 0 : item.img) {
                  _push2(`<div class="${ssrRenderClass([`${unref(hoverIdx) === i ? "block" : "hidden"}`, "absolute top-0 right-[50px] p-[10px] bg-white"])}" data-v-3da2c1bf${_scopeId}><img${ssrRenderAttr("src", item == null ? void 0 : item.img)} class="h-[110px] max-w-fit" alt="" data-v-3da2c1bf${_scopeId}><p class="text-[chocolate] text-[12px] whitespace-nowrap m-0" data-v-3da2c1bf${_scopeId}>${ssrInterpolate(item == null ? void 0 : item.text)}</p></div>`);
                } else if (!(item == null ? void 0 : item.img) && (item == null ? void 0 : item.text)) {
                  _push2(`<p class="${ssrRenderClass([`${unref(hoverIdx) === i ? "block" : "hidden"}`, "hover-p w-auto"])}" data-v-3da2c1bf${_scopeId}>${ssrInterpolate(item.text)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
              } else {
                return [
                  createVNode(_component_IconsFontAwesome, {
                    icon: item == null ? void 0 : item.icon_class,
                    size: item.icon_size,
                    onMouseenter: ($event) => switchHoverIdx(i),
                    onMouseleave: ($event) => switchHoverIdx(-1)
                  }, null, 8, ["icon", "size", "onMouseenter", "onMouseleave"]),
                  (item == null ? void 0 : item.img) ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: [`${unref(hoverIdx) === i ? "block" : "hidden"}`, "absolute top-0 right-[50px] p-[10px] bg-white"]
                  }, [
                    createVNode("img", {
                      src: item == null ? void 0 : item.img,
                      class: "h-[110px] max-w-fit",
                      alt: ""
                    }, null, 8, ["src"]),
                    createVNode("p", { class: "text-[chocolate] text-[12px] whitespace-nowrap m-0" }, toDisplayString(item == null ? void 0 : item.text), 1)
                  ], 2)) : !(item == null ? void 0 : item.img) && (item == null ? void 0 : item.text) ? (openBlock(), createBlock("p", {
                    key: 1,
                    class: [`${unref(hoverIdx) === i ? "block" : "hidden"}`, "hover-p w-auto"]
        ...
        _push(`<!--]--><li style="${ssrRenderStyle(unref(showToTopIcon) ? null : { display: "none" })}" id="toTopIcon" class="navbar-icon-style text-slate-200 hover:text-white cursor-pointer" data-v-3da2c1bf>`);
        _push(ssrRenderComponent(_component_IconsFontAwesome, {
          size: 20,
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Common/Pendant.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3da2c1bf"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconsFontAwesome = _sfc_main$3;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "text-left text-[#6c757d] p-6 bg-[rgba(248,249,250,1)] h-[70px]" }, _attrs))}><section class="flex justify-center">`);
      if (unref(footerConfig).right.is_show) {
        _push(`<div class="flex-grow"></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(footerConfig).right.is_show && unref(footerConfig).right.list.length > 0) {
        _push(`<div class="flex text-[20px] text-black"><!--[-->`);
        ssrRenderList(unref(footerConfig).right.list, (item) => {
          _push(`<a${ssrRenderAttr("href", item.url)} target="_blank" class="pr-6">`);
          _push(ssrRenderComponent(_component_IconsFontAwesome, {
            size: item.icon_size,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const scrollListenerHandler = () => {
      var _a;
      const wrapTop = ((_a = (void 0).getElementById("wrap")) == null ? void 0 : _a.getBoundingClientRect().top) || 0;
      if (wrapTop < 75) {
    ...
    onUnmounted(() => {
      (void 0).removeEventListener("scroll", scrollListenerHandler);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CommonHeader = __nuxt_component_0;
      const _component_CommonPendant = __nuxt_component_1;
      ...
      _push(`<div id="wrap" class="w-full xl:w-[1200px] mx-auto min-h-[calc(100vh-244px)] my-[16px]">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div>`);
      _push(ssrRenderComponent(_component_CommonPendant, null, null, _parent));
...
//# sourceMappingURL=default-KWYPoSjr.mjs.map
